...
## 4.1 Arquitetura do FUKG (Fictional Universe Knowledge Graph)
...
## 4.2 A Ontologia de Universos Ficcionais
...
2. **Propriedades Mutáveis (Mutable Properties):** Atributos que evoluem no tempo, como "Aliança", "Posse de Item", ou "Estado Civil", codificando o "Evolucionário" inspirado pelo EKG (EVOLUTIONARY KNOWLEDGE, 2020).
...
## 4.3 Mecanismos de Raciocínio Temporal e Lógico
...
## 4.4 Visualização Interativa, Layout e Usabilidade
...
## 4.5 Trade-offs: Expressividade vs. Performance
