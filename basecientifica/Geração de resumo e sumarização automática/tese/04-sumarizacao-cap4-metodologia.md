...
## 3.2 Protocolo de Revisão Sistemática (PRISMA)
...
## 3.3 Método Proposto: Framework HNS-PT
...
## 3.4 Critérios de Avaliação e Validação
...
## 3.5 Considerações Éticas e de Privacidade
