# 2 REFERENCIAL TEÓRICO E REVISÃO SISTEMÁTICA
...
### 2.1.1 NER no Domínio Literário
...
### 2.1.2 Identificação de Personagens e Correferência
...
## 2.3 Tabela Comparativa (Visão Geral da Literatura)
