...
exports.groupAndAnalyzeLexicon = groupAndAnalyzeLexicon;
exports.groupSimilarDocumentsSemantic = groupSimilarDocumentsSemantic;
exports.desambiguateWordContext = desambiguateWordContext;
exports.generateContextualWordLinks = generateContextualWordLinks;
/**
 * Remove stopwords brasileiras/portuguesas e calcula frequências lematizadas de palavras (UC-020).
 */
function groupAndAnalyzeLexicon(text, excludeTerms = []) {
 ...
 */
function groupSimilarDocumentsSemantic(documents, sensitivity = 0.5 // Slider de rigidez (UC-021)
) {
 ...
 */
function desambiguateWordContext(word, surroundingText) {
 ...
 */
function generateContextualWordLinks(currentText, projectLexicon) {
