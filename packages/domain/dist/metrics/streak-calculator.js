...
exports.calculateDailyQuota = calculateDailyQuota;
/**
 ...
 */
function calculateStreak(streak, todayStr, wordsWrittenToday, minWordsForStreak = 200) {
 ...
 */
function calculateDailyQuota(totalTarget, currentWritten, deadlineStr, todayStr) {
    ...
    if (diffDays <= 0)
        return remaining; // deadline is today or past
