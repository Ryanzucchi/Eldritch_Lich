 ...
 */
function searchInText(content, query, options = {}) {
    if (!content || !query)
        return [];
 ...
 */
function replaceMatchInText(content, match, replacement) {
    if (!content || !match)
        return content;
 ...
 */
function replaceAllInText(content, query, replacement, options = {}) {
