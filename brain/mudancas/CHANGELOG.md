...
## [2026-07-24] (Linhas do Tempo, Mídia e Core Editor) - UC-055, UC-056, UC-058, UC-393, UC-394, UC-412, UC-065, UC-067, UC-068 & UC-069

### ⏳ Linhas do Tempo e Relações Causais (UC-055, UC-056, UC-058)
...
*   **Relacionamento Causal entre Eventos (UC-056):** Vínculo lógico de eventos como precursores/causas de outros eventos. Função `validateTimelineConsistency` em `@eldritch/domain` detecta inconsistências cronológicas.
*   **Visualização Cronológica Interativa (UC-058):** Página dedicada `/timeline` com renderização horizontal interativa de marcadores de tempo, cards de eventos e sinalização visual de dependências.
